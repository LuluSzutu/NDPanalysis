function FITCfoci2D(IM,Impath,Imfile,Iwidth,Iheight,analysis,thresh)
    ...
    if max(I(:)) == 0 && min(I(:)) == 0
        ...
        if analysis(3) == 1
            ...
            for j = 1:num
                ...
                if Bp>=nucTb && Bp<nucTb2 && Gp>nucT && Gp-Bp>-50 && stats(j).Area>minisize
                    if stats(j).Eccentricity <= 0.80
                        ...
                        if max(L(:)) > 1                  
                            ...
                            for k = 2:max(L(:))
                                ...
                                if Bp>=nucTb && Bp<nucTb2 && Gp>nucT && Gp-Bp>-50 && stats2(k).Area>minisize
